	...
	<body>
		<div id='bigBox'>
			...
			<div id='contenedorBox'>
				<div id='home' class='sliderBox'>Slider</div>
				...
				<div id='comunidad' class='cabecera'>
					...
					<div class='twBox cajaSocial'>
						<a href="https://twitter.com/tuvidatusreglas" target='_blank'>
							<div class='logoSocial'>
			...
			<div class='footerBox'>
				<div class='footerInteriorBox'>
					...
					<div class='footerText'>
						<div class='sharpText'>
							Nullam in elit magna lectus gravida rhoncus, hymenaeos lorem, duis cras justo, sodales eros vel proin rutrum natoque duis, neque commodo quisque eget nunc. Ipsum mi mauris quisque praesent proin, potenti magna, venenatis vitae lacus.
						</div>
					</div>
				</div>
			</div>
